...
\textbf{Lưu ý về sự mâu thuẫn giữa điểm số trung bình và ví dụ định tính:} Người đọc có thể nhận thấy một sự mâu thuẫn thú vị: Mặc dù \textit{Greedy Search} đạt điểm ROUGE và BERTScore trung bình cao nhất trên toàn tập dữ liệu (Bảng \ref{tab:decoding_eval}), nhưng trong ví dụ cụ thể tại Bảng \ref{tab:decoding_case_study}, nó lại thể hiện sự hạn chế (tập trung sai ngữ cảnh vào "chiếc xe tăng" thay vì "chiến lợi phẩm của Nga"). Hiện tượng này rất phổ biến trong xử lý ngôn ngữ tự nhiên: ROUGE thiên về việc đếm số lượng từ vựng trùng khớp (n-gram overlap) và Greedy Search thường có xu hướng sao chép các cụm từ vựng sát với đoạn đầu của văn bản gốc (nơi thường chứa nhiều từ khóa quan trọng). Tuy nhiên, về mặt ngữ nghĩa toàn cục (global semantic), \textit{Greedy Search} do không có khả năng duy trì nhiều giả thuyết cùng lúc nên dễ rơi vào cực tiểu địa phương (local optima), dẫn đến việc bỏ sót ý chính. Trái lại, \textit{Beam Search} nhờ khả năng đánh giá đồng thời nhiều đường dẫn nên đã tổng hợp được bức tranh toàn cảnh một cách chính xác hơn trong trường hợp này. Điều này tái khẳng định rằng, trong các hệ thống tóm tắt thực tế, việc chỉ dựa vào độ đo tự động là không đủ, và \textit{Beam Search} vẫn là lựa chọn an toàn hơn cho chất lượng ngữ nghĩa cuối cùng.
