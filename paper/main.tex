...
\paragraph{Phân tích theo độ dài văn bản (Length Analysis).} 
Chúng tôi chia tập kiểm thử thành ba nhóm độ dài: ngắn ($<300$ từ), trung bình ($300-600$ từ), và dài ($>600$ từ). Kết quả cho thấy hiệu năng của Qwen2.5 suy giảm nghiêm trọng khi văn bản dài ra. Cụ thể, trong khi ROUGE-1 của Qwen2.5 trên các bài báo ngắn đạt 49.85 (chênh lệch $\sim$1.2 điểm so với BARTpho), thì trên các bài báo $>600$ từ, ROUGE-1 của Qwen2.5 rơi mạnh xuống mức 42.94, tạo ra khoảng cách lớn lên tới 6.4 điểm so với BARTpho (49.32). Sự suy giảm này chứng tỏ rằng Qwen2.5 (phiên bản Base 0.5B) gặp khó khăn trong việc duy trì chú ý đúng trọng tâm (attention allocation) ở các văn bản quá dài, đặc biệt khi chưa được tinh chỉnh cấu trúc (Instruction Tuning) bài bản cho nhiệm vụ tóm tắt. Trái lại, BARTpho giữ được hiệu năng khá ổn định bất chấp độ dài văn bản (chỉ giảm nhẹ từ 51.06 xuống 49.32).

\paragraph{Phân tích hiện tượng lặp (Trigram Repetition Rate).}
Nhằm định lượng mức độ suy thoái cấu trúc, chúng tôi tính toán Tỷ lệ lặp Trigram (Trigram Repetition Rate) trên các bản tóm tắt. Kết quả cho thấy BARTpho kiểm soát việc lặp từ rất tốt, với tỷ lệ lặp chỉ ở mức 0.55\% (FFT) và 0.69\% (LoRA). Ngược lại, Qwen2.5 có tỷ lệ lặp lên đến 10.32\%. Nghĩa là cứ 10 cụm 3 từ do Qwen2.5 sinh ra thì có 1 cụm bị lặp lại. Sự suy thoái cục bộ này (local degeneration) không chỉ giải thích vì sao Qwen2.5 nhận điểm đánh giá LLM-as-a-Judge thấp về mặt Tính nhất quán (Consistency) và Mạch lạc (Coherence), mà còn là một nguyên nhân trực tiếp kéo điểm ROUGE-1 đi xuống (do các từ bị lặp không đóng góp thêm vào việc khớp từ mới trong văn bản chuẩn).
